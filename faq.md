...
* Your homework solution will be submitted electronically on [Gradescope]({{ site.gradescope }}).
...
* Each group will create a single submission and upload it to [Coursys]({{ site.coursys }}) on or before the due date.
