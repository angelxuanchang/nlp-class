...
\begin{frame}{No solution with single neuron (perceptron)}
\begin{block}{}
...
\end{block}
\note{single neural unit cannot compute
some very simple functions of its input.}
\end{frame}
...
\begin{frame}{Word embeddings: re-train or not?}
\centering
